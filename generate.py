...
def generate_unconditional_seq(model_path, seq_len, device, bias=10):
    ...
    gen_seq = model.generate(inp, initial_hidden, seq_len, bias)

    return gen_seq


def generate_conditional_sequence(model_path, char_seq, device, char_to_id, idx_to_char, bias=5.):
